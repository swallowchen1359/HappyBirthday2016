...
public class CrossView extends View {
    ...
    private static int DEFAULT_PAINT_THICK_RES_ID = R.dimen.cross_thick;
    private static int DEFAULT_CROSS_SIZE_RES_ID = R.dimen.cross_size;
    private static int DEFAULT_PAINT_COLOR_RES_ID = R.color.cross_color;
